...
namespace ProductManager.Service.Concrete
{
    public sealed class UserManagementService : IUserManagementService
    {
        ...
        private async Task SendInvitationEmailAsync(ApplicationUser user)
        {
            ...
            var subject = "ProductManager Portal - Hesabınız Oluşturuldu";
            var body = $@"
                <html>
                <body style='font-family: Arial, sans-serif;'>
                    <h2>Hoş Geldiniz!</h2>
                    <p>Merhaba {user.FirstName} {user.LastName},</p>
                    <p>ProductManager Portal hesabınız oluşturuldu. Şifrenizi belirlemek için aşağıdaki butona tıklayın:</p>
                    <p>

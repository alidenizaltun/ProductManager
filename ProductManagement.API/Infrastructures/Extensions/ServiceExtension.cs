...
using ProductManagement.API.Infrastructures.Helpers;
...
using ProductManagement.Service.Abstract;
...
using ProductManagement.Shared.Infrastructure.Helpers;
using Dapper;
using Hangfire;
...
namespace ProductManagement.API.Infrastructures.Extensions
{
    public static class ServiceExtension
    {
        ...
        public static void ConfigureAuthentication(this IServiceCollection service, IHostApplicationBuilder builder)
        {
            ...
            service.AddSingleton<IAuthorizationHandler, ProductManagement.Shared.Infrastructure.Security.PermissionAuthorizationHandler>();
            service.AddSingleton<IAuthorizationPolicyProvider, ProductManagement.Shared.Infrastructure.Security.PermissionPolicyProvider>();
        }
        ...
        public static void ConfigureSwagger(this IServiceCollection service, IHostApplicationBuilder builder)
        {
            service.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        Title = "ProductManagement Web Api Service - v1",
                        Version = "v1",
                        Description = $"ProductManagement uygulamasının arayüz api hizmetidir.",
                ...
                options.SwaggerDoc("v2",
                    new OpenApiInfo
                    {
                        Title = "ProductManagement Web Api Service - v2",
                        Version = "v2",
                        Description = $"ProductManagement uygulamasının arayüz api hizmetidir.",
                        TermsOfService = new Uri("https://devayazilim.com.tr/"),
                        Contact = new OpenApiContact
        ...
        public static void AddAllManagerIOC(this IServiceCollection service)
        {
            ...
            service.Scan(selector => selector
                .FromAssemblies(
                    typeof(ProductManagement.Service.AssemblyRefrence).Assembly
                )

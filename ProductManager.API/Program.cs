using ProductManager.API.Infrastructures.Extensions;
...
using DateTimeConverter = ProductManager.Shared.Infrastructures.Converters.DateTimeConverter;
...
try
{
    ...
    builder.Services.AddFluentValidationAutoValidation()
        ...
        .AddValidatorsFromAssembly(typeof(ProductManager.Presentation.AssemblyReference).Assembly);
    ...
    app.MapScalarApiReference(options =>
    {
        ...
        options.WithTitle("Product Manager API Documentation");
